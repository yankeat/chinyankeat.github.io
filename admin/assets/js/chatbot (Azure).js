...
function add_answers() {
    ...
    command["intent"]   = $("#addSingleAnswer .modal-body #add_s_intent").val();
    command["entity"]   = $("#addSingleAnswer .modal-body #add_s_entity").val();
    command["entity1"]  = $("#addSingleAnswer .modal-body #add_s_entity1").val();
    command["entity2"]  = $("#addSingleAnswer .modal-body #add_s_entity2").val();
    command["answer"]   = $("#addSingleAnswer .modal-body #add_s_answer").val();
    command["quick_reply"] = $("#addSingleAnswer .modal-body #add_s_quick_reply").val();
    command["quick_reply_value"] = $("#addSingleAnswer .modal-body #add_s_quick_reply_value").val();

    $.ajax({
		type: "POST",
		url: urlstring, data: { data: JSON.stringify(command) }, cache: false, async: true, timeout: 10000,
		success: function (data) {
...
function update_answers() {
    ...
    command["id"]       = $("#editSingleAnswer .modal-title .id").text();
    command["intent"]   = $("#editSingleAnswer .modal-body #s_intent").val();
    command["entity"]   = $("#editSingleAnswer .modal-body #s_entity").val();
    command["entity1"]  = $("#editSingleAnswer .modal-body #s_entity1").val();
    command["entity2"]  = $("#editSingleAnswer .modal-body #s_entity2").val();
    command["answer"]   = $("#editSingleAnswer .modal-body #s_answer").val();
    command["quick_reply"] = $("#editSingleAnswer .modal-body #s_quick_reply").val();
    command["quick_reply_value"] = $("#editSingleAnswer .modal-body #s_quick_reply_value").val();
...
function get_answers(intent, entity, entity1, entity2) {
    ...
    $("#answers_multiple").empty();
    command = {};
    command["command"] = "webhook_admin_get_answer";
    command["intent"] = intent;
    command["entity"] = entity;
    command["entity1"] = entity1;
    command["entity2"] = entity2;
	$.ajax({
		type: "POST",
		url: urlstring, data: { data: JSON.stringify(command) }, cache: false, async: true, timeout: 10000,
        //		crossDomain: true,
...
//		},
        ...
        message = "";
        message = message + "<tr>"
        message = message + "<td> ID </td>"
        message = message + "<td > Intent</td>"
        message = message + "<td > Entity (Topic) </td>"
        message = message + "<td > Entity 1 (SubTopic) </td>"
        message = message + "<td > Entity 2 (Detail) </td>"
...
function add_answers_multiple() {
    ...
    command["intent"] = $("#addMultipleAnswer .modal-body #add_m_intent").val();
    command["type"] = $("#addMultipleAnswer .modal-body #add_m_type").val();
    command["image"] = $("#addMultipleAnswer .modal-body #add_m_image").val();
    command["answer"] = $("#addMultipleAnswer .modal-body #add_m_answer").val();
    command["subtitle"] = $("#addMultipleAnswer .modal-body #add_m_subtitle").val();
    command["quick_reply"] = $("#addMultipleAnswer .modal-body #add_m_quick_reply").val();
    command["quick_reply_value"] = $("#addMultipleAnswer .modal-body #add_m_quick_reply_value").val();
	$.ajax({
		type: "POST",
		url: urlstring, data: { data: JSON.stringify(command) }, cache: false, async: true, timeout: 10000,
...
function update_answers_multiple() {
    ...
    command["id"] = $("#editMultipleAnswer .modal-title .id").text();
    command["intent"] = $("#editMultipleAnswer .modal-body #m_intent").val();
    command["type"] = $("#editMultipleAnswer .modal-body #m_type").val();
    command["image"] = $("#editMultipleAnswer .modal-body #m_image").val();
    command["answer"] = $("#editMultipleAnswer .modal-body #m_answer").val();
    command["subtitle"] = $("#editMultipleAnswer .modal-body #m_subtitle").val();
    command["quick_reply"] = $("#editMultipleAnswer .modal-body #m_quick_reply").val();
    command["quick_reply_value"] = $("#editMultipleAnswer .modal-body #m_quick_reply_value").val();
	$.ajax({
		type: "POST",
		url: urlstring, data: { data: JSON.stringify(command) }, cache: false, async: true, timeout: 10000,
		success: function (data) {
