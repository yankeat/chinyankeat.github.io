...
$tsql = "seek_insert_promotion";

// $param1 = str_replace("'", "''",'test');
// $param2 = str_replace("'", "''",'test Ad');
// $param3 = 19999;

$param1 = str_replace("'", "''",$json->customer_name);
$param2 = str_replace("'", "''",$json->product_id);
$param3 = str_replace("'", "''",$json->promo_type);
$param4 = str_replace("'", "''",$json->minimum_qty);
$param5 = str_replace("'", "''",$json->promo_price);
$param6 = str_replace("'", "''",$json->bundle_order_qty);
$param7 = str_replace("'", "''",$json->bundle_charge_qty);
